...
router.get('/community/:id/update', community_controller.community_update_get)
router.post('/community/:id/update', community_controller.community_update_post)
router.post('/community/delete', community_controller.community_delete)
// Community-Comment
